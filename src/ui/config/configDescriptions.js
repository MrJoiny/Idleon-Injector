...
export const configDescriptions = {
    ...
    // Royal Guardian & Kingdom
    "cheatConfig.w6.royal.StatueUpgOdds": "Royal Guardian: Statue upgrade odds",
    "cheatConfig.w6.royal.Statue_CanAfford": "Royal Guardian: Statue affordability check",
    "cheatConfig.w6.royal.Statue_Cost": "Royal Guardian: Statue upgrade cost. (lower is better)",
    "cheatConfig.w6.royal.StatueBon": "Royal Guardian: Statue bonus multiplier",
    "cheatConfig.w6.royal.SF_unlocked": "Royal Guardian: Statue flair unlock state",
    "cheatConfig.w6.royal.SF_maxLV": "Royal Guardian: Statue flair max level",
    "cheatConfig.w6.royal.SF_costo": "Royal Guardian: Statue flair upgrade cost. (lower is better)",
    "cheatConfig.w6.royal.SF_weOwn": "Royal Guardian: Statue flair owned shards",
    "cheatConfig.w6.royal.SF_bonus": "Royal Guardian: Statue flair bonus",
    "cheatConfig.w6.royal.StatueEXPmulti": "Royal Guardian: Statue EXP multiplier",
    "cheatConfig.w6.royal.ArmoryUpgUNLOCKED": "Royal Guardian: Armory upgrades unlocked count",
    "cheatConfig.w6.royal.ArmoryUpgTotal": "Royal Guardian: Total armory upgrades count",
    "cheatConfig.w6.royal.ArmoryUpgCost": "Royal Guardian: Armory upgrade costs. (lower is better)",
    "cheatConfig.w6.royal.ArmoryUpgBonus": "Royal Guardian: Armory upgrade bonus value",
    "cheatConfig.w6.royal.RatResp": "Royal Guardian: Verminous rat respawn rate",
    "cheatConfig.w6.royal.RatDMG": "Royal Guardian: Damage dealt to Verminous rats",
    "cheatConfig.w6.royal.ParchmentDrop": "Royal Guardian: Parchment of Enchantment drop rate",
    "cheatConfig.w6.royal.ParchmentDouble": "Royal Guardian: Parchment double drop chance",
    "cheatConfig.w6.royal.ParchmentRecycle": "Royal Guardian: Parchment recycle value",
    "cheatConfig.w6.royal.MarbleDrop": "Royal Guardian: Marble drop rate",
    "cheatConfig.w6.royal.GuardianRoyalRadius": "Royal Guardian: Royal aura radius",
    "cheatConfig.w6.royal.RI_chance": "Royal Guardian: Regal Intervention proc chance",
    "cheatConfig.w6.royal.RI_mobs": "Royal Guardian: Regal Intervention mobs count",
    "cheatConfig.w6.royal.OrbletMultiDrop": "Royal Guardian: Orblet drop multiplier",
    "cheatConfig.w6.royal.KingdomEnabled": "Kingdom: Kingdom enabled check",
    "cheatConfig.w6.royal.Yi_OutpostInfo": "Kingdom: Outpost info query",
    "cheatConfig.w6.royal.HasOutpost": "Kingdom: Check if outpost exists on map",
    "cheatConfig.w6.royal.OutpostKillsReq": "Kingdom: Outpost kills requirement. (lower is better)",
    "cheatConfig.w6.royal.OutpostTypesUnlocked": "Kingdom: Outpost types unlocked",
    "cheatConfig.w6.royal.OutpostTypesAllowed": "Kingdom: Outpost types allowed",
    "cheatConfig.w6.royal.OutpostROGbon": "Kingdom: Outpost rank bonuses",
    "cheatConfig.w6.royal.SupportEXP": "Kingdom: Support units EXP gain",
    "cheatConfig.w6.royal.SupportCollection": "Kingdom: Support units collection bonus",
    "cheatConfig.w6.royal.SavageCollection": "Kingdom: Savage collection bonus",
    "cheatConfig.w6.royal.XtraClearKillz": "Kingdom: Extra clear kills per kill",
    "cheatConfig.w6.royal.BarExpRate_Base": "Kingdom: Base bar EXP rate",
    "cheatConfig.w6.royal.BarExpRate": "Kingdom: Total bar EXP rate",
    "cheatConfig.w6.royal.MapOutpostBarUnlockedTot": "Kingdom: Total outpost bars unlocked",
    "cheatConfig.w6.royal.OutpostEXPformula": "Kingdom: Outpost EXP formula value",
    "cheatConfig.w6.royal.OutpostEXPreq": "Kingdom: Outpost EXP requirement. (lower is better)",
    "cheatConfig.w6.royal.OutpostEXPreqPREV": "Kingdom: Previous rank outpost EXP requirement",
    "cheatConfig.w6.royal.OutpostEXPrank": "Kingdom: Outpost EXP rank",
    "cheatConfig.w6.royal.OutpostPTSleft": "Kingdom: Outpost specialty points remaining",
    "cheatConfig.w6.royal.OutpostCost": "Kingdom: Outpost upgrade cost. (lower is better)",
    "cheatConfig.w6.royal.OutpostLV_Bonuses": "Kingdom: Outpost level bonuses",
    "cheatConfig.w6.royal.UnitSpecEffect": "Kingdom: Unit specialty effect value",
    "cheatConfig.w6.royal.isMapPurified": "Kingdom: Map purification status",
    "cheatConfig.w6.royal.OutpostResourceRate": "Kingdom: Resource collection rate",
    "cheatConfig.w6.royal.OutpostRange": "Kingdom: Outpost connection range",
    "cheatConfig.w6.royal.OutpostPurifyBonus": "Kingdom: Outpost purification bonus",
    "cheatConfig.w6.royal.MapOutpostBarUnlocked": "Kingdom: Outpost bar unlocked on map",
    "cheatConfig.w6.royal.MapWorldsUnlocked": "Kingdom: Worlds unlocked for outpost expansion",
    "cheatConfig.w6.royal.MapButtonsUnlock": "Kingdom: Map buttons unlock status",
    "cheatConfig.w6.royal.CanWeDoubleConnect": "Kingdom: Double connection capability",
    "cheatConfig.w6.royal.UnitsUnlocked": "Kingdom: Number of units unlocked",
    "cheatConfig.w6.royal.GEDunlocked": "Kingdom: GED unlock status",
    "cheatConfig.w6.royal.ActiveKillClear": "Kingdom: Active kill clear rate",
    "cheatConfig.w6.royal.OutpostUnitSlots": "Kingdom: Outpost unit slots available",
    "cheatConfig.w6.royal.ResNodeQTYmax": "Kingdom: Resource node max capacity",
    "cheatConfig.w6.royal.ResNodes_LVUP": "Kingdom: Resource node level up",
    "cheatConfig.w6.royal.ResNodes_LVUPbon": "Kingdom: Resource node level up bonus",
    "cheatConfig.w6.royal.PassiveUnitsz": "Kingdom: Passive units calculation",
    "cheatConfig.w6.royal.TotalSupports": "Kingdom: Total support units",
    "cheatConfig.w6.royal.TotalUnitsz": "Kingdom: Total units count",
    "cheatConfig.w6.royal.TotalStatz": "Kingdom: Total stats calculation",
